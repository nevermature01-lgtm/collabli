...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:block absolute top-4 right-4 w-[140px] bg-white rounded-xl shadow-[0_8px_20px_rgba(0,0,0,0.06)] p-3 z-20 animate-in fade-in slide-in-from-right-10 duration-1000">
