...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:block absolute top-[120px] right-[80px] w-[260px] bg-white rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.08)] p-6 z-20 animate-in fade-in slide-in-from-right-10 duration-1000">
        ...
        <p className="text-[11px] text-gray-400 mt-4 tracking-widest uppercase font-bold">
          — FASHION & LIFESTYLE CREATOR
        </p>
      </div>

      {/* Floating Testimonial Card 2 */}
      <div className="hidden lg:block absolute top-[280px] right-[40px] w-[260px] bg-white rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.08)] p-6 z-20 animate-in fade-in slide-in-from-right-10 duration-1000 delay-300">
        <div className="text-[#0ab99d] text-2xl font-serif mb-1 leading-none">“</div>
        <p className="text-[14px] text-gray-700 leading-relaxed font-medium">
