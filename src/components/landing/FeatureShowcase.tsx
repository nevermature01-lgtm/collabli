...
export const FeatureShowcase: React.FC = () => {
  ...
  return (
    <section className="bg-[#f5f2eb] py-4 md:py-6 px-4 text-center overflow-hidden">
      ...
      >
        ...
        <div className="relative overflow-hidden rounded-t-2xl" style={{ transform: 'translateZ(30px)' }}>
          ...
          <div className="absolute top-3 left-3 flex flex-col gap-2" style={{ transform: 'translateZ(45px)' }}>
            {creator.isTop && (
              <span className="inline-flex items-center gap-1.5 bg-black/90 text-[#FFD700] text-[9px] font-extrabold tracking-[1px] uppercase px-2.5 h-[20px] rounded-none backdrop-blur-md border border-[#FFD700]/40 shadow-[0_0_15px_rgba(255,215,0,0.3)]">
